          ...
          justifyContent="center" alignItems="center">
           ...
           <Grid item>
            <Grid
              ...
              justifyContent="center" alignItems="center">
                ...
                <img className="img-fluid" alt="scatterplot" src="img/example06b.png" width={250} height={250}/>
            </Grid>
          </Grid>
           ...
           <Grid item>
            <Grid
              container direction="column"
              justifyContent="center" alignItems="center">
                <img style={{ border: '2px solid #A79AFF' }} className="img-fluid" alt="scatterplot" src="img/example06a.png" width={250} height={250}/>
           ...
           <Grid item>
            <Grid
              ...
              justifyContent="center" alignItems="center">
                ...
                <img style={{ border: '2px solid green' }} className="img-fluid" alt="scatterplot" src="img/example06c.png" width={250} height={250}/>
            </Grid>
          </Grid>
