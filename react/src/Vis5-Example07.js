  ...
  return (
      <Grid 
        ...
        <Grid item>
          ...
          <br />
          <p>Which scatterplot (<strong>Option A</strong> or <strong>Option B</strong>) have a more similar cluster structure to the reference scatterplot? <br/> You can click the button or the image.</p>
          ...
          justifyContent="center" alignItems="center">
           ...
           <Grid item>
            <Grid
              ...
              justifyContent="center" alignItems="center">
                ...
                <img onClick={() => { buttonClick(1) }} className="img-fluid" alt="scatterplot" src="img/example07b.png" width={250} height={250}/>
            </Grid>
          </Grid>
           ...
           <Grid item>
            <Grid
              container direction="column"
              justifyContent="center" alignItems="center">
                <img style={{ border: '2px solid #A79AFF' }} className="img-fluid" alt="scatterplot" src="img/example07a.png" width={250} height={250}/>
           ...
           <Grid item>
            <Grid
              ...
              justifyContent="center" alignItems="center">
                ...
                <img onClick={() => { buttonClick(0) }} className="img-fluid" alt="scatterplot" src="img/example07c.png" width={250} height={250}/>
            </Grid>
          </Grid>
