...
export default function Home() {
  ...
  return (
    <Container maxWidth="md">
      ...
      <h4><a style={linkStyle} href="http://jiquadcs.com">Ghulam Jilani Quadri</a>, <a style={linkStyle} href="https://jennifer.adorno.me">Jennifer Adorno Nieves</a>, <a style={linkStyle} href="https://wiernik.org">Brenton M. Wiernik</a> and <a style={linkStyle} href="https://cspaul.com/wordpress/">Paul Rosen</a></h4>
      ...
      <Grid container
        ...
        style={{ paddingBottom: '75px' }}>
         ...
         <Grid item>
          <Grid
            container direction="row" spacing={5}
